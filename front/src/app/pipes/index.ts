...
export * from './user-check-status-pipe'
...
import {UserCheckStatus} from './user-check-status-pipe'

export const CUSTOM_PIPES = [
  ClipPipe, DatePipe, ItemStatusPipe, OrderStatusPipe, BidStatusPipe, AuctionTypePipe, BoolPipe, RemainTimePipe, Num2strPipe,HidePipe,UserCheckStatus
];
